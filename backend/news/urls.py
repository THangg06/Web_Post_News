...
from .views import PostViewSet, CategoryViewSet, CommentViewSet, hello, admin_dashboard, admin_user_detail, admin_recompute_predictions
...
urlpatterns = [
    ...
    path('admin/predictions/recompute/', admin_recompute_predictions),
